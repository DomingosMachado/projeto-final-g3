...
const X = {
  count: 200,
    colors: [
    0x8A2BE2,  // Roxo-violeta vibrante (cor principal)
    0x9932CC,  // Roxo escuro
    0xBA55D3,  // Roxo médio
    0xDDA0DD,  // Roxo claro/lavanda
    0xE6E6FA,  // Lavanda claro
    0x9370DB,  // Roxo médio-azulado
    0xDA70D6   // Orchid (rosa-roxo)
  ],
  ambientColor: 0xFFFFFF, // Branco para iluminação ambiente
  lightIntensity: 1.5,    // Intensidade aumentada para cores mais vivas
  materialParams: {
    metalness: 0.3,       // Reduzido para cores mais vibrantes
    roughness: 0.4,
    clearcoat: 0.8,
